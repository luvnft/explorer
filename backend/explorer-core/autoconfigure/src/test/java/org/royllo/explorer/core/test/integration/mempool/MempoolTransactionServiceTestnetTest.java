...
public class MempoolTransactionServiceTestnetTest {
    ...
    public void getTransaction() {
        ...
        assertThat(mempoolTransactionService.getTransaction("d8a8016095b9fcd1f63c57342d375026ecbc72c885a54b676c6e62b216e15365").block())
                .isNotNull()
                .satisfies(transaction -> {
                    assertEquals(2348688, transaction.getStatus().getBlockHeight().intValue());
                    assertEquals(1664417898, transaction.getStatus().getBlockTime().longValue());
