...
import static org.royllo.test.TapdData.ROYLLO_COIN_ASSET_ALIAS;
...
public class DisplayRoylloCoinTest extends BaseWebTest {

    // Asset tested.
    String assetId = ROYLLO_COIN_ASSET_ID;
    String assetIdAlias = ROYLLO_COIN_ASSET_ALIAS;
    DecodedProofValueResponse.DecodedProof assetFromTest = ROYLLO_COIN_FROM_TEST.getDecodedProofResponse(0);
